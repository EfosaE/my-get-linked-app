const CriteriaData = [
  {
    ...
    text:
      "Evaluate the uniqueness and creativity of the solution. Consider whether it addresses a real-world problem a novel way or introduces innovative features.   ",
  },
  {
    title: "Functionality",
    text:
